...
export const seoRoutes: SeoRouteRecord[] = [
  ...
  {
    path: '/faq/',
    title: 'Website questions answered – Luca Kosowski',
    description: 'Clear answers about starting, shaping, building, hosting, delivering, and improving a website with Luca Kosowski.',
    family: 'service',
    language: 'en',
  },
  {
    path: '/website-check/',
    title: 'Website Readiness Check – Websites by Luca Kosowski',
    description: 'Run an automated first-pass review of visible website HTML signals for trust, clarity, SEO basics, accessibility, and conversion readiness.',
    family: 'service',
    language: 'en',
  },
  {
